"""Span Similarity Dataset validator.

Example usage::

   python validate_dataset.py ../../span-similarity-dataset/span_similarity_dataset_v1.0.0-train.tsv
"""
...
arg_parser = argparse.ArgumentParser(
    description=("Validate the Span Similarity Dataset."),
    formatter_class=argparse.RawTextHelpFormatter,
)
arg_parser.add_argument("dataset", help="the dataset to validate")
...
class DatasetValidator:
    ...
    def validate(self, dataset_path: str, print_to_console: bool = True) -> int:
        ...
        with open(dataset_path, "r", encoding="utf-8") as f:
            ...
            for i, line in enumerate(reader, 2):
                ...
                elif self._get_non_spans(premise) != self._get_non_spans(hypothesis):
                    self._log_error(
                        f"[Line {i}] The out-of-span text differs between premise and hypothesis.",
                        print_to_console,
                    )
...
def main():
    ...
    validator.validate(args.dataset)
